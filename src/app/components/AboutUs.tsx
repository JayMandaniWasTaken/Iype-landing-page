      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 relative z-10">
          ...
          <div className="flex flex-col gap-6 group hover:-translate-y-2 transition-transform duration-300">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Every product is engineered with a focus on biomechanics, comfort, and durability. We ensure athletes can push their limits without compromising mobility or form, turning functional workouts into more effective sessions.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6 group hover:-translate-y-2 transition-transform duration-300">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Inspired by Dr. Iype Cherian, IYPE ATHLETIQ brings together science, athletic performance, and innovative design to create equipment built for serious training.
            </p>
          </div>
