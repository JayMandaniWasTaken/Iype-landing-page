    ...
    <>
      <section className="bg-black min-h-screen text-white flex flex-col font-['Inter',_sans-serif] relative overflow-hidden" style={{ isolation: 'isolate' }}>
        ...
        <div
          ...
          style={{
            WebkitMaskImage: `
            linear-gradient(to right, black 0%, black 25%, rgba(0,0,0,0.8) 45%, rgba(0,0,0,0.3) 70%, transparent 95%),
            linear-gradient(to top, transparent 0%, rgba(0,0,0,0.5) 10%, black 25%),
            linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.5) 5%, black 20%)
          `,
            maskImage: `
            linear-gradient(to right, black 0%, black 25%, rgba(0,0,0,0.8) 45%, rgba(0,0,0,0.3) 70%, transparent 95%),
            linear-gradient(to top, transparent 0%, rgba(0,0,0,0.5) 10%, black 25%),
        ...
        >
          ...
          <div
            className="absolute inset-0 bg-gradient-to-r from-transparent via-black/20 to-black z-10"
            style={{
              background: "linear-gradient(to right, transparent 0%, transparent 40%, rgba(0,0,0,0.4) 60%, rgba(0,0,0,0.8) 85%, black 100%)"
            }}
          />
          {/* Grain / noise texture */}
          <div
      ...
      <div
        className={`md:hidden fixed inset-0 z-[9999] transition-all duration-300 ${isMobileMenuOpen
      ...
      >
        ...
        <div
          className={`flex flex-col items-center justify-center h-full gap-8 transition-transform duration-300 ${isMobileMenuOpen ? "translate-y-0" : "-translate-y-8"
            }`}
        >
          <a
            href="#products"
